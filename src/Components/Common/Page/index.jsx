                    ...
                    {categories.map((category) => (
                        <NavLink to={`/page/detail`}>
                            ...
                            >
                                ...
                                {/* Content */}
                                <CardBody className="relative z-10 text-left p-8 min-h-[280px] flex flex-col items-start justify-end">
                                    <Typography
                                        variant="h3"
                                        className="font-bold !text-white relative z-[1000]  mb-2 text-shadow-lg "
                                    >
                                        {category.name}
                                    </Typography>
                                </CardBody>
